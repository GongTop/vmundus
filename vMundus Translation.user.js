...
$("li#store").html('더보기<ul class="submenu"><a href="market"><li class="subli">상점</li></a> <!--★//--> </ul>');
...
if(location.toString().match(/^https:\/\/vmundus\.com\/en\/company_manage\?/)) {
    $('input#h_exp_input.h_input').attr('value', '1');
    $('input#h_salary_input.h_input').attr('value', '11');
}
